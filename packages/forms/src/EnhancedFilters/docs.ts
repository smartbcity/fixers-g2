...
export const EnhancedFiltersClasses = `
interface EnhancedFiltersClasses {
    actions?: string
    button?: string
    field?: string
}
...
export const EnhancedFiltersStyles = `
interface EnhancedFiltersStyles {
...
export const EnhancedFiltersState = `
export type EnhancedFiltersState = ReturnType<typeof useEnhancedFiltersik>
`
